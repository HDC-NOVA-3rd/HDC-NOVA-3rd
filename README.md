...
# 🏠 스마트 아파트 통합관리 플랫폼 — NOVA
### Team 파이브가이즈

**IoT와 AI를 결합한 스마트 아파트 통합관리 플랫폼**

입주민 모바일 앱과 관리자 웹을 연동하여  
주거 환경 제어와 단지 운영을 효율적으로 관리할 수 있는 올인원 시스템입니다.
...
| ----------------------- | --------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **안창석**<br/> | Team Leader         | https://github.com/AhnCSK | 🔹 관리자 인증 시스템 및 보안 로직 구현<br/>🔹 민원 및 고지서 관리(PDF/Excel) 구현<br/>🔹 QueryDSL 기반 DB 조회 성능 최적화<br/>🔹 관리자 전용 웹 대시보드 구현<br/>🔹 앱 민원/고지서 확인 구현                         |
| **이희원**                 | AI & Design     | https://github.com/heewonn09 | 🔹 AI 파이프라인 설계 및 총괄 관리<br/>🔹 Gemini, OpenRouter 기반 챗봇 구축<br/>🔹 Pinecone 활용 RAG 파이프라인 구축<br/>🔹 앱 챗봇 UI 구현<br/>🔹 서비스 GUI 및 물리 구조물 설계                          |
| **양준길**                 | Infra & Backend | https://github.com/wnsrlf0721 | 🔹 CI/CD 파이프라인 및 Docker Compose 구축<br/>🔹 JWT 및 OAuth 2.0 기반 로그인 시스템 구현<br/>🔹 시설 예약, QR 출입 시스템, FCM 푸시 알림 구현<br/>🔹 부하 테스트 및 API 성능 병목 개선<br/>🔹 출입 관리 디바이스 구현 |
| **천경신**                 | AI & IoT        |https://github.com/sthasq| 🔹 화재 및 가스 감지 로직 및 MQTT 토픽 총괄 설계 및 브로커 구축<br/>🔹 Hugging Face 기반 음성인식 아키텍처 구현<br/>🔹 안전 관제 대시보드 및 공지사항 웹/앱 기능 개발<br/>🔹 MQTT 디바이스 제어 연동 및 AI 스피커 구현<br/>🔹 웹 인터페이스 디자인      |
| **최우영**                 | IoT & Hardware  | https://github.com/eddy0417| 🔹 디바이스 상태 API 및 환경 센서 데이터 연동<br/>🔹 사용자 설정 모드 스케줄러(Automation) 구현<br/>🔹 홈/디바이스 제어 UI 및 기능 구현<br/>🔹 IoT 물리 구조물 설계 및 하드웨어 구축<br/>🔹 OpenWeather API 연동         |
...
> <img width="1095" height="602" alt="image" src="https://github.com/user-attachments/assets/15d59f28-63a9-4854-995c-c6c7a48aa72d" />

## 📱 서비스 화면

> ><img width="2396" height="1287" alt="image" src="https://github.com/user-attachments/assets/3dc8e47e-50e3-45d0-a1d2-9aa54c1045f5" />

><img width="2415" height="1284" alt="image" src="https://github.com/user-attachments/assets/8057825c-6e6d-4d57-adce-8269d653a64a" />

---


## 프로젝트 일정
<img width="1117" height="577" alt="image" src="https://github.com/user-attachments/assets/282d2231-7f9b-4e33-bb74-48b22756e67d" />
...
## 실물 모형
### 전체 
<img width="1332" height="644" alt="image" src="https://github.com/user-attachments/assets/b35429ef-e9cc-4a6c-aafa-c3c71e6165da" />

### AI 스피커 & 시설 출입구 
<img width="837" height="699" alt="image" src="https://github.com/user-attachments/assets/2f442a9d-7a86-46e5-9372-8db8942f9235" />

### 집 환경 
<img width="1509" height="674" alt="image" src="https://github.com/user-attachments/assets/ce199543-6589-427e-8b24-04970d20f27e" />

---

##  🎬 영상으로 보는 소개 - 사진 클릭!

[![시연 영상](https://github.com/user-attachments/assets/aa4c51b1-60d9-4927-bcee-78aff0781712)](https://drive.google.com/file/d/1b-vz5VNmS-BF1424KBxGbMl939a8d0pX/view?usp=sharing)
